...
.before\:ui4-box-border:before, .ui4-box-border {
 ...
 <div class="errors"><div id="banlist" class="errors-notify-list-container" style="width:180%">
     <div class="error-notify danger">
         <div class="error-notify__header-container"style="background-color: #13b601;">
