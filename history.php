...
<div id="pay" class="mainn" style="width: 6rem;">
    <span id="numbers" class="tops">ПС</span>
</div>


<div id="telephonesz" class="mainn" style="width: 10rem;">
    <span id="numbers" class="tops">Реквизиты</span>
</div>
<div id="summm" class="mainn" style="width: 8rem;">
    <span id="numbers" class="tops">Сумма</span>
</div>
<div id="dataaa" class="mainn" style="width: 13.5rem;">
    <span id="numbers" class="tops">Дата</span>
</div>
<div id="dataaa" class="mainn" style="width: 11rem;">
    <span id="numbers" class="tops">Время</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output2?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel2?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum2?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data2?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech23?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output3?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel3?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum3?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data3?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech24?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output4?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel4?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum4?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data4?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech25?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output5?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel5?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum5?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data5?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech26?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output6?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel6?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum6?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data6?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech27?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output7?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel7?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum7?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data7?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech28?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output8?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel8?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum8?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data8?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech29?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output9?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz" class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel9?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum9?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data9?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech291?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
...
<div id="pay" class="rank_def transition" style="width: 6rem;">
    <img id="ico" src="<?=$output10?>" style="width: 36px;margin-left:20px; " alt="ico">
</div>
<div id="telephonesz"class="rank_def transition" style="width: 10rem;">
    <span id="numbers" class="telephone">+79<?=$koshel10?>***</span>
</div>
<div id="summm" class="rank_def transition" style="width: 8rem;">
    <span id="numbers" class="summaa"><?=$sum10?> ₽</span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 13.5rem;">
    <span class="datas"><?=$data10?></span>
</div>
<div id="dataaa"class="rank_def transition" style="width: 11rem;">
    <span class="times"><?=$sech292?> ч. назад</span>
</div>
<div id="stats" class="rank_def transition" style="width: 10.5rem;">
    <span id="statusnumbers" class="statuses">Выплачено</span>
</div>
