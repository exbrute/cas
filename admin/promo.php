...
<li class="nav-item active" ><a href="/admin/promo" class="nav-link">Промокоды</a></li>
		...
		<div class="card-head">
            ...
            <hr>          
                     ...
                     <div class="card-text"> 
                      ...
                      <center>
<div id="promo-tbl">
<table  class="table-responsive-sm table table-bordered table-hover table-checkable" style="width:100%">
...
<!-- MODAL -->
    ...
    <hr>
    <p>Название
<input type='text' class='form-control col-12' id='promoname' value='' placeholder='Название промокода'></p><br>
    <p>Сумма
<input type='text' class='form-control col-12' id='promosum' value='' placeholder='Сумма промокода'></p><br>
    <p>Кол-во активаций
<input type='text' class='form-control col-12' id='promoact' value='' placeholder='Кол-во активаций промокода'></p><br>
    <!-- ОПОВЕЩЕНИЯ -->
