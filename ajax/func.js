      ...
      if(obj.bombs == "true"){
       ...
       $("#finishmines").attr("disabled","disabled");
          ...
          $("#win").html("0.00");
           ...
           } else $(".mine[data-number="+obj.tamines[i]+"]").html('<img src="../images/bomb.png" style="width:27px; height:37px">');
          ...
          // $("#bombHistoryContent").prepend(obj.resultHistoryContentBomb);
               ...
               $('#win').html(obj.win);
               $(".mine[data-number="+obj.pressmine+"]").html('<img src="../images/gem.svg" style="width:60%; height:50%">');
           $("#startmines").attr("disabled","disabled");
       $("#finishmines").removeAttr("disabled","disabled");
