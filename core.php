...
$game1 = $row['game'];
					$g = '';
					if($game1 == 1){
						$g = '<i class="ga fas fa-dice-d6" style="margin-top: 4px; color: #6157f3;" aria-hidden="true"></i>';
					}
					if($game1 == 2){
						$g = '<i class="ga fas fa-gem" style="margin-top: 4px; color: #6157f3;" aria-hidden="true"></i>';
					}
					if($game1 == 3){
