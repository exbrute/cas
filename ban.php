...
<div class="header-wrappers">
    <img src="/extra/panel/icoKenoZZ.png" style="width: 36px;margin-right:12px; " alt="ico">
         ...
         <div class="error-notify__header-container">
             ...
             <div class="error-notify__body">
                 <div class="error-notify__content-container">
                     <h4 class="error-notify__title">Вы нарушили условия предоставления услуг</h4> 
                     <p class="error-notify__description">Напишите в поддержку, если у вас есть вопросы по блокировке!</p> 
