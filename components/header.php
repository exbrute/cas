...
.header-wrappers{
    box-shadow: 0px 0px 20px #1000ff40;
}
.activel{
...
.dicebtn{
    box-shadow: 0px 0px 20px #ffc6428c;
}
.preloader {
position: fixed;
left: 0;
...
<link href="css/wnoty1.css" rel="stylesheet">
...
<body style="background-color: #F7F5FE;  background-image: url(/components/bg.png);">
 </body>
...
.rheader__link--nonactive {
  ...
  <a aria-current="page" href="/index" id="indexpage1" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 26px;margin-top: -2px;margin-right: 2px; ">list</span> Главная </a>
  <a aria-current="page" href="/bonus" id="bonuspage1" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 23px;margin-top: -2px;margin-right: 2px; ">redeem</span> Бонусы </a>
  <a aria-current="page" href="/ref" id="revpage1" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 23px;margin-top: -2px;margin-right: 2px; ">percent</span> Рефералы </a>

  <a onclick="myFunction55()" aria-current="page" class="router-link-active rheader__link--nonactive rheader__link " style="  cursor:pointer;  color: #b6b0d7;"><span class="material-icons" style="font-size: 23px;margin-top: -2px;margin-right: 2px; ">more_horiz</span> Ещё </a>

  <a aria-current="page" href="/credit" id="revpage1" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 23px;margin-top: -2px;margin-right: 2px; ">credit_score</span> Займ </a>
  ...
  <div id="myDropdown" class="dropdown-content" style="margin-left: 24rem;margin-top: 18.6rem;">
    ...
    <a href="/history"style="color: #707d8e;"><span class="material-icons" style="font-size: 21px;margin-top: -2px;margin-right: 2px; color: #707d8e; ">schedule</span> Все выплаты</a>
     <a href="#modalVoucher" data-toggle="modal" style="color: #707d8e;"><span class="material-icons" style="font-size: 21px;margin-top: -2px;margin-right: 2px; color: #707d8e; ">vpn_key</span> Ваучер</a>
         <a href="/tournament"style="color: #707d8e;"><span class="material-icons" style="font-size: 21px;margin-top: -2px;margin-right: 2px; color: #707d8e; ">emoji_events</span> Турнир</a>
  </div>
  ...
  <a aria-current="page" href="/index" id="" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 26px;margin-top: -2px;margin-right: 2px; ">list</span> Главная </a>
    <a aria-current="page" href="/faq" id="" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 26px;margin-top: -2px;margin-right: 2px; ">contact_support</span> FAQ </a>
      <a aria-current="page" href="/support" id="" class="router-link-active rheader__link--nonactive rheader__link "><span class="material-icons" style="font-size: 26px;margin-top: -2px;margin-right: 2px; ">alternate_email</span> Контакты </a>
...
?> 
      ...
      <div onclick="Valuta()" class="balanceview noedit" style="margin-right: 6%; cursor: pointer;">


          <img img src="/extra/money.png" style="margin-left: 80%; margin-top: 10%;font-size: 18px;color: #69d344;    width: 16px;">
                                                                  <h5 class="odometer odometer-auto-theme" id="userBalance" style="margin-top: -1.25rem;margin-left: 0.5rem;color: #7064a7;"><?=$balance;?></h5>
 ...
 <img src="/images/gem.png"  onclick="location.href = '/ranks';" style="cursor:pointer; width:40px;">
 ...
 <div id="ValutaDropbox" class="dropdown-contentV" style="right: 370;top: 70;">
    ...
    <a onClick="ValuteError();"class="12343" style="color: #707d8e;cursor:pointer;"><span style="color: black;">BTC</span> - 0.00</a>
     ...
     <a onClick="ValuteError();"class="12343" style="color: #707d8e;cursor:pointer;    background: #f5f5f5;text-align: center;border-radius: 0.5rem;">Конвертация</a>   
         ...
         <div class="d-md-none d-block mg-t-8 mg-l-15">
                        ...
                        <a href="/deposit" class=" btndeposit2 btn-brand-01 btn-uppercase mg-l-5 bt-mob" style=" font-size: 13px;   background: linear-gradient(45deg,#5a53f1,#7e6afc 98.44%);    border-color: #7967fa;">Пополнить</a>
            <a href="/withdraw" class="btn btnwithdraw2 btn-uppercase bt-mob" style="font-size: 13px;max-width:150px;cursor:pointer; background:#eae4ff;">Вывод</a>
        ...
        <div class="d-md-none  dropdown-profile " >
            ...
            <a class="dropdown-link " style="cursor: pointer;" onclick="location.href = '/me';">
                ...
                <div class="pd-l-15 ">
                    ...
                    <img src="/images/gem.png"  onclick="location.href = '/ranks';" style="cursor:pointer; width:40px;margin-top: -2.5rem;margin-left:6rem;">
  ...
  <!--      <img src="/extra/logobar2.png" height="45"  alt="logo" style="float: right;"> -->
	...
	<? if ($youtube == 0){?>
           ...
           <?}else if($youtube == 1){?>  
              <a  onClick="ytWithdraw();"  class="btn btnwithdraw btn-uppercase flex-fill mg-r-10" style="font-size: 13px;max-width:150px;cursor:pointer">Вывод</a> 
            <?}?>
            
            <a  href="/deposit" class="btn btndeposit btn-brand-01 btn-uppercase flex-fill " style=" font-size: 13px;   background: linear-gradient(45deg,#5a53f1,#7e6afc 98.44%);    border-color: #7967fa;">Пополнить</a>
