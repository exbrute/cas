...
<li onclick="window.location.href='/dice1'" id="menudice" class="media align-items-center mg-t-15 gameinc">
...
<h6 class="mg-b-2"><a href="/dice1" class="link-01 tx-18">Dice</a></h6>
</div>
</li>
...
<div class="mg-l-5 btn-withdraw mg-t-5 wd-65 ht-65 bg-gray-100 rounded d-inline-flex align-items-center justify-content-center" onclick="$('#walletNumber').attr('placeholder','+7XXXXXXXXX'); $('#nameWt').html('Qiwi кошелек');$('#depositSystem').val('3'); $('.btn-withdraw').removeClass('bd-gray-500 bd-1 bd') ;$(this).addClass('bd-gray-500 bd-1 bd')">
...
<input type="number" class="form-control tx-light tx-16 tx-normal" id="depositSystem">
...
<button id="succes_withdraw" style="margin-left: 7px; padding: 8px 22px; pointer-events: none; display:none" class="btn tx-medium btn-la-mob bg-success-dice tx-white bd-0 btn-sel-d "></button>
...
$status = $row['status'];
if($status == 0) {
$remove = "<a class='badge badge-danger'  onclick="."removeWithdrawUser('$id_w')".">Отменить</a>";
...
echo "<tr class='text-center' style='cursor:default!important' id='$id_w'><td>$id_w</td><td>$date_w</td><td style='overflow-x: auto;'><img src='images/$ps.png'> $wallet</td><td>$sum_w</td><td>$badge $remove</td></tr>";                                        
}
                                      ?>
...
<a href="https://cabura.com/login.php" class="btn btn-outline-facebook btn-block mg-b-15"><i class="ion ion-logo-vk"></i> Войти через Вконтакте</a>
<div class="form-group">
<label>Логин</label>
...
<h3 id="wizard1-h-0" tabindex="-1" class="title current tx-center ">Подпишитесь на <a href="https://vk.com/cabura" target="_blank" style="text-decoration: underline;">нашу группу</a></h3>
...
<img src="files/card.png" style="width:45px">
</div>
...
<a href="mailto:support@cabura.com" class="nav-link"><u>support@cabura.com</u></a>
</nav>
</div>
</footer>
</div>
