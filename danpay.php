 ...
 <div class="errors"><div id="banlist" class="errors-notify-list-container" style="width:180%">
     <div class="error-notify danger">
         <div class="error-notify__header-container">
             ...
             <h5 class="error-notify__header">Ошибка</h5></div> 
             <div class="error-notify__body">
                 <div class="error-notify__content-container">
                     <h4 class="error-notify__title">Ошибка при проведении платежа</h4> 
            ...
            На главную
          </button style=""></div></div></div> <div class="error-notify__aside"><img src="/images/info.png" style="    height: 210px;" alt="error-image"></div></div></div> <!----></div></div>                
