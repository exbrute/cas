...
$refs = array();
	...
	$refs = array(['x' => "08.11.2023", 'y' => 3], ['x' => "09.11.2023", 'y' => 2]);
	 $result = array(
'chart' => $refs,
'er' => "0"
    );
...
$r = 'svg';
if($status == 0) {
$remove1 = '<small class="tx-12 tx-color-03 mg-b-0 refund tx-light id-mob" onclick="removeWithdraw('.$id_w.')">⇆ Отменить</small>';



$remove = '<span onclick="removeWithdraw('.$id_w.')" class="tx-warning" style="margin-right: 1rem;padding: 7px 8px 3px; border-radius: 15px;width: 2.3rem;height: 2.3rem;background: #ffd4d7;color: #dc3545;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;cursor:pointer;"> <span class="material-icons" style="font-size: 22px; ">close</span></span></p> <span style="color:#fd7e14;"></span> ';
?>
<style>
...
$badge = '<span class="tx-warning" style="padding: 9px 8px 3px; border-radius: 15px;width: 3rem;height: 3rem;background: #ffe9cf;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;"> <span class="material-icons" style="font-size: 30px; ">schedule</span></span></p> <span style="color:#fd7e14;"></span> ';
}
if($status == 1) {
$remove = '';
$badge = '<span tooltip="Выплачено" flow="down" class="tx-success" style="color: #11b115;padding: 9px 8px 3px; border-radius: 15px;width: 3rem;height: 3rem;background: #d6ffc5;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;"> <span class="material-icons" style="font-size: 30px; ">task_alt</span></span></p> <span style="color:#fd7e14;"></span> ';    
...
if($status == 3) {
$remove = '';
$badge = '<span tooltip="Агрегатор" flow="down" class="tx-warning" style="padding: 9px 8px 3px; border-radius: 15px;width: 3rem;height: 3rem;background: #ffe9cf;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;"> <span class="material-icons" style="font-size: 30px; ">speed</span></span></p> <span style="color:#fd7e14;"></span> ';
}

if($status == 2) {
$remove = '';
$badge = '<span tooltip="Ошибка" flow="down" class="tx-warning" style="color:#dc3545;padding: 9px 8px 3px; border-radius: 15px;width: 3rem;height: 3rem;background: #ffd4d7;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;"> <span class="material-icons" style="font-size: 30px; ">block</span></span></p> <span style="color:#fd7e14;"></span> ';
}  

if($status == 4) {
$remove = '';
$badge = '<span tooltip="Отозван" flow="down" class="tx-warning" style="color:#dc3545;padding: 9px 8px 3px; border-radius: 15px;width: 3rem;height: 3rem;background: #ffd4d7;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;"> <span class="material-icons" style="font-size: 30px; ">cancel</span></span></p> <span style="color:#fd7e14;"></span> ';
} 

if($status == 5) {
$remove = '';
$badge = '<span tooltip="Тех. отдел" flow="down" class="tx-warning" style="color:#dc3545;padding: 9px 8px 3px; border-radius: 15px;width: 3rem;height: 3rem;background: #ffd4d7;display: inline-block; align-items: center; text-align: center; white-space: nowrap; vertical-align: baseline;"> <span class="material-icons" style="font-size: 30px; ">build_circle</span></span></p> <span style="color:#fd7e14;"></span> ';
} 
...
<li id="'.$id_w.'_his" class="list-item d-flex bd-t bd-r-0 bd-l-0">
                ...
                <div class="d-flex align-self-center">
                    <div class="avatar wt-ava1 mg-l-wallet-10"><span class=" wt-ava"style="margin-top: -5px; margin-left: -15px;padding: 9px 8px 3px;  border-radius: 15px;  width: 3rem; height: 3rem; background: #f0ecff; display: inline-block;  align-items: center; text-align: center; white-space: nowrap;vertical-align: baseline;"><img src="files/assets/'.$ps.'icon.'.$r.'" style="height:30px; width:23px;object-fit: fill;"></span></div>
                    <div class="pd-l-10">
                        <p class="tx-medium mg-b-0 tx-14 id-mob wallet-mob" style="color: #7266a8;">'.$wallet.'</p>
                        <small class="tx-12 tx-color-03 mg-b-0 tx-light id-mob" style="color:#bbb5d8;">'.$date_w.'</small>
                    </div>
                    
                </div>
                <div class="mg-l-auto text-right amo-mob" style="display: flex;">
                    <p class="tx-medium mg-b-0 tx-16  id-mob wallet-mob "style="align-items: center;display: flex;"><span style="margin-right:1rem;    color: #b6b0d7;"> '.$sum_w.' RUB </span>
                    '.$remove.''.$badge.'
...
$publickey = 'mw4f7yljoi596nz'; // публичный ключ в настройках кассы

$label = $user_id; // ID платежа в вашей системе
$amount = $size; // Сумма платежа
...
$sign = hash('sha256', $shop_id.$amountnum.$publickey.$label); // генерация HASH
  $fa = "success";
    ...
    $result = array(
	'success' => "success",
	'locations' => "https://sci.fropay.bid/get?amount=".$amountnum."&desc=MTAyMTU=&shop_id=".$shop_id."&label=".$label."&hash=".$sign.""
    );
...
if($wallet == '' || $sum == '') {
  $error = 1;
  $mess = "Выберите платежную систему";
  $fa = "error";
}
if($sum > $balance) {
  $error = 2;
...
$error = 1;
$fa = "error";
$mess = "Вы уже получали ежедневный бонус! Возвращайтесь через 24 часа.";
}
